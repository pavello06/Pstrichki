...
Begin
    ...
    With StartForm Do
    Begin
        DrawButton(GameImage, RatioCoefficient, 'Играть');
        DrawButton(SettingsImage, RatioCoefficient, 'Настройки');
        DrawButton(RuleImage, RatioCoefficient, 'Правила');
        DrawButton(ExitImage, RatioCoefficient, 'Выйти');
    End;
...
Begin
    ...
    DrawButton(SettingsForm.BackImage, RatioCoefficient, 'Назад');
...
Begin
    ...
    DrawButton(RuleForm.BackImage, RatioCoefficient, 'Назад');
...
Begin
    ...
    With PauseForm Do
    Begin
        DrawButton(ContinueImage, RatioCoefficient, 'Продолжить');
        DrawButton(RestartImage, RatioCoefficient, 'Новая игра');
        DrawButton(BackImage, RatioCoefficient, 'В главное меню');
    End;
...
Begin
    ...
    DrawButton(WinForm.ContinueImage, RatioCoefficient, 'Продолжить');
End;
